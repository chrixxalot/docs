...
\cvitem{
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item Priorisierung und Steuerung des Produkt-Backlogs in enger Abstimmung mit Entwicklung, Qualität und Kunden
        \item 2025: Fahrzeuganlauf der Neuen Klasse als Inhouse-Entwicklungsprojekt
    \end{itemize}
}
...
\cvitem{
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item 2021: Fahrzeuganlauf des BMW iX
    \end{itemize}
}

\cvitem{
    \cvdurationstyle{2013 -- 2016}
}{
    \cvtitle{Softwareintegrator Embedded Systems / AUTOSAR}

    BMW AG

    \begin{itemize}[leftmargin=*]
        \item Integration von Software für ein Embedded-Systems-AUTOSAR-Steuergerät
        ...
        \item 2015: Fahrzeuganlauf des BMW X5
        \item 2013: Fahrzeuganlauf des BMW i3
    \end{itemize}
}
...
\cvitem{
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item Diplomarbeit bei der IT-Designers GmbH, Esslingen, in Kooperation mit der Daimler AG, Sindelfingen: ``Inbetriebnahme eines Vorserien-Autosar-Stacks der Firma Vector Informatik sowie Erstellung einer prototypischen Anwendung nach dem Autosar-Vorgehensmodell unter Verwendung der Werkzeugkette DaVinci''
...
\cvitem{
    ...
    Software / Programmiersprache -- Kenntnisstand

    Weitere Anwendung -- Kenntnisstand
}
